        ...
        <div className="px-6 pb-8">
          <div className="max-w-3xl mx-auto flex flex-col items-center gap-3">
            <motion.button
              ...
              whileTap={analysisState === 'idle' && selectedFile ? { scale: 0.95 } : {}}
              className={`
              ...
              `}
              style={{ borderRadius: analysisState === 'idle' ? 14 : 28, overflow: 'hidden' }}
              aria-label={analysisState === 'loading' ? 'Analyzing...' : 'Analyze X-Ray'}
            >
                ...
                {analysisState === 'loading' ? (
                  ...
                  >
                    <div className="flex items-center justify-between w-full text-xs font-semibold">
                      ...
                      <span className="tabular-nums font-mono">{Math.min(progress, 100)}%</span>
                    </div>
            ...
            >
              <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div>
                  ...
                  <div className="px-2">
                    <FindingsSummary findings={result.findings} />
                  </div>
                </div>

                {/* Viewer + Sidebar */}
                <div ref={viewerRef} className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-6 items-start">
                  <XrayViewerPanel
                    result={result}
